        ...
        <div class="card mb-4">
            <div class="card-body text-center py-5">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                    <a href="{{ route('activities.create') }}" class="btn btn-primary btn-lg me-md-2">
                ...
                <div class="row text-center">
                    <div class="col-md-3">
                        <div class="border-end">
                            <h3 class="text-primary mb-1">{{ \App\Models\Activity::count() }}</h3>
                            <small class="text-muted">Total Activities</small>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border-end">
                            <h3 class="text-success mb-1">{{ \App\Models\Activity::where('status', 'scheduled')->count() }}</h3>
                            <small class="text-muted">Scheduled</small>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="border-end">
                            <h3 class="text-info mb-1">{{ \App\Models\Activity::where('status', 'completed')->count() }}</h3>
                            <small class="text-muted">Completed</small>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <h3 class="text-warning mb-1">{{ \App\Models\Activity::where('status', 'pending')->count() }}</h3>
