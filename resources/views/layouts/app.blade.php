...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('title', 'Outdoor Activity Scheduler')</title>
        ...
        <div class="container">
            <a class="navbar-brand" href="{{ url('/') }}">
                ...
                <div class="brand-text">
                    <div class="brand-title">{{ config('app.name', 'Outdoor Activity Scheduler') }}</div>
    ...
    <footer class="footer py-5 mt-5">
        <div class="container">
            ...
            <div class="footer-copyright">
                ...
                <p class="mb-0">
                    © {{ date('Y') }} <strong>Hitachi Internal System Developer</strong> - Outdoor Activity Scheduler
                    <br>
