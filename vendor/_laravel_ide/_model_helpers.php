...
namespace App\Models {
     ...
     * @property \Illuminate\Support\Carbon|null $selected_time_slot
     ...
     * @property-read mixed $formatted_time_slot
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereLocation($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereSubDistrict($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereVillage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity wherePreferredDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereSelectedTimeSlot($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereWeatherCondition($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity whereNotes($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity forDate()
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity byStatus()
     * @method static \Illuminate\Database\Eloquent\Builder<Activity>|Activity byLocation()
